...
myfpsDict = {}
tempDict = {}
for subdir, dirs, files in os.walk("selected/target"):
    a = subdir.split("/")
...
gearppw = np.array([mydict["gearDVFStargetUtil-0.15"], mydict["gearDVFStargetUtil-0.1"], mydict["gearDVFStargetUtil0.0"], mydict["gearDVFStargetUtil0.05"], mydict["gearDVFStargetUtil0.1"], mydict["gearDVFStargetUtil0.15"]])
gearfps = np.array([mydict["gearDVFStargetUtil-0.15"], mydict["gearDVFStargetUtil-0.1"], mydict["gearDVFStargetUtil0.0"], mydict["gearDVFStargetUtil0.05"], mydict["gearDVFStargetUtil0.1"], mydict["gearDVFStargetUtil0.15"]])
